...
function MainWatch({
  ...
  return (
    <div
      className={`${!customizeActive ? "top-[33.75rem] scale-[2]" : "top-0 scale-[1]"} absolute left-1/2 -translate-x-1/2 transition-all delay-[0.4s] duration-[1.1s] ease-in max-w-1023-max-w-736:top-[40%] max-w-1023-max-w-736:-translate-y-1/2`}
    >
