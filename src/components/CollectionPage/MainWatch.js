...
function MainWatch({
  ...
  return (
    <div
      className={`${!customizeActive ? "top-[33.75rem] scale-[2] min-w-768-max-w-1024-noLandscape:top-[175%] max-w-1023-max-w-736:top-[430px] max-w-1023-max-w-736:scale-[1.7]" : "top-0 scale-[1] max-w-1023-max-w-736:top-[55%] max-w-1023-max-w-736:-translate-y-[40%]"} absolute left-1/2 -translate-x-1/2 transition-all delay-[0.4s] duration-[1.1s] ease-in`}
    >
